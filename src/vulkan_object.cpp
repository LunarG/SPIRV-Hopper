...
VKAPI_ATTR VkBool32 VKAPI_CALL DebugUtilMessengerCallback(VkDebugUtilsMessageSeverityFlagBitsEXT, VkDebugUtilsMessageTypeFlagsEXT,
    ...
    if (
        ...
        // Some shaders default spec constant values are invalid shaders.
        // This is just limitation of spirv-hopper
        (callback_data->messageIdNumber == static_cast<int32_t>(0x437c19d3)) ||
...
VulkanInstance::VulkanInstance() {
    ...
    // Logical Device Creation
    {
        ...
        auto physical_device_shader_clock_features =
        ...
        auto physical_device_rtx_motion_blur_features_nv = LvlInitStruct<VkPhysicalDeviceRayTracingMotionBlurFeaturesNV>(
            &physical_device_shader_subgroup_uniform_control_flow_features);
        auto physical_device_maintenance5_features =
            LvlInitStruct<VkPhysicalDeviceMaintenance5FeaturesKHR>(&physical_device_rtx_motion_blur_features_nv);
